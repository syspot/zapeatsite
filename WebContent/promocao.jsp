...
<head>
<%@ include file="/head_promocao.jsp"%>
</head>
                    ...
                    <c:when test="${promocaoFaces.tipoPromocao}">
                        <div id="boxSobreEstab">
                            <a href="estabelecimento.jsf?cidade=${cidadeFaces.cidadeSelecionada}&id=${promocaoFaces.promocao.fornecedorModel.id}">
                                <div class="marca">
                                    <img src="${promocaoFaces.promocao.fornecedorModel.logoMarcaView}" width="117" height="117" alt="${promocaoFaces.promocao.fornecedorModel.nomeFantasia}" title="${promocaoFaces.promocao.fornecedorModel.nomeFantasia}" />
                                </div>
                                <p class="titulo marginBottom15px">${promocaoFaces.promocao.fornecedorModel.nomeFantasia} - ${promocaoFaces.promocao.fornecedorModel.bairro}</p> <!--<div class="marginBottom5px">
			                	 <a href="" title="Indico"><span class="icons indicacaoAzul"></span>Eu Indico [100]</a>  
			                </div> -->
                                <div>
                                    <span class="icons telAzul"></span>${promocaoFaces.promocao.fornecedorModel.telefone}
                                </div>
                            </a>
                        </div>
                        <c:if test="${not empty promocaoFaces.promocao.imagensPromocoes}">
                            <div class="boxSubCat ftoLocal">
                                ...
                                <c:forEach items="${promocaoFaces.promocao.imagensPromocoes}" var="item">
                                    <span class="floatLeft"> <a class="fotoEstab" href="${item.imagemFullView}"> <img src="${item.imagemThumbView}" width="180" height="109" />
                                    </a>
                                    </span>
                                </c:forEach>
                            </div>
                    ...
                    <c:otherwise>
                        <div id="boxSobreEstab">
                            <a href="estabelecimento.jsf?cidade=${cidadeFaces.cidadeSelecionada}&id=${promocaoFaces.carroChefe.fornecedorModel.id}">
                                <div class="marca">
                                    <img src="${promocaoFaces.carroChefe.fornecedorModel.logoMarcaView}" width="117" height="117" alt="${promocaoFaces.carroChefe.fornecedorModel.nomeFantasia}" title="${promocaoFaces.carroChefe.fornecedorModel.nomeFantasia}" />
                                </div>
                                <p class="titulo marginBottom15px">${promocaoFaces.carroChefe.fornecedorModel.nomeFantasia} - ${promocaoFaces.carroChefe.fornecedorModel.bairro}</p> <!--<div class="marginBottom5px">
			                	 <a href="" title="Indico"><span class="icons indicacaoAzul"></span>Eu Indico [100]</a>  
			                </div> -->
                                <div>
                                    <span class="icons telAzul"></span>${promocaoFaces.carroChefe.fornecedorModel.telefone}
                                </div>
                            </a>
                        </div>
                ...
                <div id="destaque">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${promocaoFaces.tipoPromocao}">
                            ...
                            <div id="fotoDestaque">
                                ...
                                <div class="tituloPromo">
                                    <p>
                                        <span class="tipoPromo">${promocaoFaces.promocao.tipoPromocaoModel.descricao}</span>
                                    </p>
                                    <p>
                                        <span class="nomePromo">${promocaoFaces.promocao.titulo}</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="boxInfo">
                                <a href="listagem.jsf?cidade=${cidadeFaces.cidadeSelecionada}&categoriaId=${promocaoFaces.promocao.fornecedorModel.categoriaPrincipal.id}" title="" class="floatLeft"><div class="floatLeft">
                                        <img src="${promocaoFaces.promocao.fornecedorModel.categoriaPrincipal.imagemView}" alt="" title="${promocaoFaces.promocao.fornecedorModel.categoriaPrincipal.descricao}" class="floatLeftMargin4" />Categoria:
                                        <c:out value="${promocaoFaces.promocao.fornecedorModel.categoriaPrincipal.descricao}" />
                                    </div></a>
                            </div>
                        ...
                        <c:otherwise>
                            ...
                            <div id="fotoDestaque">
                                ...
                                <div class="tituloPromo">
                                    <p>
                                        <span class="tipoPromo">Carro chefe</span>
                                    </p>
                                    <p>
                                        <span class="nomePromo">${promocaoFaces.carroChefe.titulo}</span>
                                    </p>
                                </div>
                            </div>
                            <div class="boxInfo">
                                <a href="listagem.jsf?cidade=${cidadeFaces.cidadeSelecionada}&categoriaId=${promocaoFaces.carroChefe.fornecedorModel.categoriaPrincipal.id}" title="" class="floatLeft"><div class="floatLeft">
                                        <img src="${promocaoFaces.carroChefe.fornecedorModel.categoriaPrincipal.imagemView}" alt="" title="${promocaoFaces.carroChefe.fornecedorModel.categoriaPrincipal.descricao}" class="floatLeftMargin4" />Categoria:
                                        <c:out value="${promocaoFaces.carroChefe.fornecedorModel.categoriaPrincipal.descricao}" />
                                    </div></a>
                            </div>
                            <blockquote class="fontYi">
                    ...
                    <div class="barraCompartilhamento">
                        <div class="recomende">
                            <c:choose>
                                <c:when test="${promocaoFaces.tipoPromocao}">
                                    <a href="http://www.facebook.com/sharer.php?u=http://www.zapeat.com/site/promocao?id=${promocaoFaces.promocao.id}" target="_blank" title="Facebook"> <img src="img/btnFb.jpg" title="Recomendar" />
                                    </a>
                                </c:when>
                                <c:otherwise>
                                    <a href="http://www.facebook.com/sharer.php?u=http://www.zapeat.com/site/carrochefe?id=${promocaoFaces.carroChefe.id}" target="_blank" title="Facebook"> <img src="img/btnFb.jpg" title="Recomendar" />
                                    </a>
                                </c:otherwise>
                            </c:choose>
                        </div>
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            <c:forEach items="${promocaoFaces.promocao.fornecedorModel.formasPagamentos}" var="formaPagamento">
                                                <span class="iconCard"> <img src="${formaPagamento.imagemView}" alt="" title="${formaPagamento.descricao}" class="floatLeftMargin4" />
                                                </span>
                                            </c:forEach>
                                        </p>
                                    </li>
