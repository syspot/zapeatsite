...
<head>
	<%@ include file="/head_estabelecimento.jsp" %>
</head>
        ...
        <div id="meio">
        	<div id="destaque">
                ...
                <div class="barraCompartilhamento">
                	<div class="recomende"><a href="http://www.facebook.com/sharer.php?u=http://www.zapeat.com/site/estabelecimento?id=${estabelecimentoFaces.fornecedorModel.id}" target="_blank" title="Facebook"><img src="img/btnFb.jpg" title="Recomendar" /></a></div>
