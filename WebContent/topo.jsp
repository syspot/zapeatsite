...
<div id="topo">
    ...
    <div id="marcaPublicidade">
        ...
        <div class="superbanner">
            <a href="${bannerFaces.bannerTopo.url}"> <img src="${bannerFaces.bannerTopo.imagemSuperiorGrandeView}" alt="" title="" />
            </a>
        </div>
    </div>
    ...
    <div id="menu">
        <nav id="categorias">
            <div id="cadastro">
                ...
                <c:if test="${empty sessionScope.idUsuarioLogado}">
                    <div id="local">
                        ...
                        <div>
                            <a class="linkCadastro" title="Cadastrar"><span class="icons iconCadastrar"></span>cadastrar</a>
                        </div>
                        <div>
                            <a class="linkLogin" title="Login"><span class="icons iconLogin"></span>login</a>
                        </div>
                    </div>
                </c:if>
            </div>
            ...
            <ul id="principal">
                ...
                <li><span class="icons maisIndicados"></span> <span class="titMenu">mais indicados</span>
                    <ul id="sub">
                ...
                <c:forEach items="${categoriaFaces.categorias}" var="item">
                    <li><span class="iconografia"><img src="${item.imagemView}" alt="" title="${item.descricao}" /></span> <span class="titMenu">${item.descricao}</span>
                        <ul id="sub">
                ...
                <li><a href="outrasCat.jsf?cidade=${cidadeFaces.cidadeSelecionada}"> <span class="iconografia"><img src="img/outrasCategorias.png" alt="" title="outras categorias" /></span> <span class="titMenu">outras categorias</span>
                </a></li>
            </ul>
        </nav>
    </div>
    ...
    <div class="container">
        ...
        <h:form id="signup" prependId="false">
            ...
            <div class="inputs">
                ...
                <span id="span_flag_aceito"> <input type="checkbox" id="flag_aceito" tabindex="103" /> <h:outputText value="Li e aceito os " styleClass="header" /> <a href="files/TermosCondicoesGeraisUsoSiteZapeat.pdf" target="_blank">Termos e Condições Gerais de Uso</a>
                </span>
                <script type="text/javascript">
																	$(
																			'#nome_div')
																			...
																			.live(
																					...
																					function() {
																						return !isEmpty(new Array(
																								...
																								"#email_div",
																								"#senha_div"))
																								&& isChecked("#flag_aceito")
																								&& validarEmail("#email_div");
																					});
																</script>
